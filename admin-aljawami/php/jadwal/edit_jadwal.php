...
if(isset($_POST['tambah'])){
	...
	if ($kd_dosen) {
		...
		//ganti dosen + Matkul +kls
			...
			//gnati matkul kls tetap
			$sqlal = "SELECT * FROM tb_jadwal,tb_dosen WHERE tb_dosen.id_dosen=tb_jadwal.kd_dosen='$kd_dosen' 
				AND hari='$hari'
			AND (  (waktu1<'$waktu1' AND waktu2>'$waktu1' AND waktu1<'$waktu2' AND waktu2>='$waktu2') 
			OR (waktu1<'$waktu1' AND waktu2>'$waktu1' AND waktu1<'$waktu2' AND waktu2<='$waktu2') 
			OR (waktu1>'$waktu1' AND waktu2>'$waktu1' AND waktu1<'$waktu2' AND waktu2>='$waktu2')
		...
		//ganti dosen doang	
			$sqldd = "SELECT * FROM tb_jadwal,tb_dosen WHERE tb_dosen.id_dosen=tb_jadwal.kd_dosen='$kd_dosen' 
	   				AND hari='$hari'
					AND (  (waktu1<'$waktu1' AND waktu2>'$waktu1' AND waktu1<'$waktu2' AND waktu2>='$waktu2') 
					OR (waktu1<'$waktu1' AND waktu2>'$waktu1' AND waktu1<'$waktu2' AND waktu2<='$waktu2') 
					OR (waktu1>'$waktu1' AND waktu2>'$waktu1' AND waktu1<'$waktu2' AND waktu2>='$waktu2')
